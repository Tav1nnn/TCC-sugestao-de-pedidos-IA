...
UPDATE restaurants SET description = 'Uma verdadeira volta ao mundo pelos sabores. O restaurante reúne pratos clássicos da culinária internacional — de entradas como bolinhos de bacalhau e patês refinados, passando por massas italianas autênticas, carnes nobres grelhadas e sobremesas tradicionais. Ideal para quem busca variedade e sofisticação.' WHERE id = '1a2b3c4d-0002';
UPDATE restaurants SET description = 'Alta gastronomia com influências europeias. Serve aves nobres como pato confitado, massas frescas recheadas com ingredientes selecionados, vinhos premium e sobremesas exclusivas, como mousse de chocolate belga e crème brûlée de lavanda. Um ambiente sofisticado para experiências inesquecíveis.' WHERE id = '1a2b3c4d-0003';
UPDATE restaurants SET description = 'Culinária afetiva com gostinho de casa. Os pratos remetem à tradição da cozinha brasileira com massas artesanais, carnes assadas lentamente, petiscos de boteco e doces clássicos como arroz doce e tiramisu. Ideal para quem valoriza comida de verdade.' WHERE id = '1a2b3c4d-0004';
UPDATE restaurants SET description = 'Um pedaço da Itália no seu prato. Especializado em culinária italiana tradicional, com foco em massas frescas, pizzas artesanais, antepastos, pratos principais como ossobuco e cordeiro ao vinho, além de sobremesas como petit gateau e torta caprese.' WHERE id = '1a2b3c4d-0005';
UPDATE restaurants SET description = 'Criações exclusivas de chefs renomados com toques contemporâneos. Pratos autorais que exploram ingredientes frescos e fusões gastronômicas, como filé mignon com crosta de castanhas e espaguete com frutos do mar. Perfeito para paladares exigentes e curiosos.' WHERE id = '1a2b3c4d-0006';
UPDATE restaurants SET description = 'Combinação de pratos clássicos com um ambiente intimista e requintado. Oferece massas delicadas como tagliatelle ao funghi, carnes nobres como T-bone e entradas refinadas como bolinhos de queijo artesanal, acompanhadas de bebidas leves e sobremesas artesanais.' WHERE id = '1a2b3c4d-0007';
UPDATE restaurants SET description = 'Receitas familiares com ingredientes sempre frescos. Ideal para quem aprecia pratos simples, mas cheios de sabor, como camarão empanado, frango grelhado e massas ao molho de tomate fresco, acompanhados de sobremesas artesanais e bebidas clássicas.' WHERE id = '1a2b3c4d-0008';
UPDATE restaurants SET description = 'Um banquete de sabores do mar e da terra. Combinando carnes nobres e frutos do mar frescos, o cardápio oferece pratos como moqueca de camarão, casquinha de siri e filé mignon ao molho madeira, além de massas artesanais e sobremesas sofisticadas.' WHERE id = '1a2b3c4d-0009';
UPDATE restaurants SET description = 'Culinária rústica com ingredientes orgânicos e da roça. Pratos fortes e tradicionais como leitão assado, costela com mandioca e massas feitas com raízes brasileiras. As bebidas naturais e sobremesas como doce de abóbora com coco complementam essa viagem ao interior.' WHERE id = '1a2b3c4d-0010';
UPDATE restaurants SET description = 'Gastronomia vegana moderna, criativa e deliciosa. O menu inclui desde burgers de grão de bico e lentilha até pratos principais como curry de legumes e lasanha de berinjela. Tudo finalizado com smoothies naturais e sobremesas veganas como mousse de maracujá.' WHERE id = '1a2b3c4d-0011';
UPDATE restaurants SET description = 'Uma explosão de sabores da culinária oriental com um toque moderno. Sushis, sashimis, pratos quentes como yakisoba e frango xadrez, acompanhados de bebidas como saquê e chá de jasmim. As sobremesas orientais finalizam a experiência com delicadeza.' WHERE id = '1a2b3c4d-0012';
UPDATE restaurants SET description = 'Autêntica culinária indiana com pratos vegetarianos e não vegetarianos ricos em temperos e aromas. Oferece clássicos como chicken tikka masala, lamb curry, palak paneer e naan, além de sobremesas como gulab jamun e lassi de manga.' WHERE id = '1a2b3c4d-0013';
UPDATE restaurants SET description = 'Um paraíso de bebidas naturais e saudáveis. Sucos combinados com frutas e ervas, smoothies energéticos, vitaminas cremosas e chás gelados aromatizados com especiarias. Ideal para quem busca refrescância com saúde.' WHERE id = '1a2b3c4d-0014';
