...
UPDATE restaurantes SET descricao = 'Uma verdadeira volta ao mundo pelos sabores. O restaurante reúne pratos clássicos da culinária internacional — de entradas como bolinhos de bacalhau e patês refinados, passando por massas italianas autênticas, carnes nobres grelhadas e sobremesas tradicionais. Ideal para quem busca variedade e sofisticação.' WHERE id = '1a2b3c4d-0002';
UPDATE restaurantes SET descricao = 'Alta gastronomia com influências europeias. Serve aves nobres como pato confitado, massas frescas recheadas com ingredientes selecionados, vinhos premium e sobremesas exclusivas, como mousse de chocolate belga e crème brûlée de lavanda. Um ambiente sofisticado para experiências inesquecíveis.' WHERE id = '1a2b3c4d-0003';
UPDATE restaurantes SET descricao = 'Culinária afetiva com gostinho de casa. Os pratos remetem à tradição da cozinha brasileira com massas artesanais, carnes assadas lentamente, petiscos de boteco e doces clássicos como arroz doce e tiramisu. Ideal para quem valoriza comida de verdade.' WHERE id = '1a2b3c4d-0004';
UPDATE restaurantes SET descricao = 'Um pedaço da Itália no seu prato. Especializado em culinária italiana tradicional, com foco em massas frescas, pizzas artesanais, antepastos, pratos principais como ossobuco e cordeiro ao vinho, além de sobremesas como petit gateau e torta caprese.' WHERE id = '1a2b3c4d-0005';
UPDATE restaurantes SET descricao = 'Criações exclusivas de chefs renomados com toques contemporâneos. Pratos autorais que exploram ingredientes frescos e fusões gastronômicas, como filé mignon com crosta de castanhas e espaguete com frutos do mar. Perfeito para paladares exigentes e curiosos.' WHERE id = '1a2b3c4d-0006';
UPDATE restaurantes SET descricao = 'Combinação de pratos clássicos com um ambiente intimista e requintado. Oferece massas delicadas como tagliatelle ao funghi, carnes nobres como T-bone e entradas refinadas como bolinhos de queijo artesanal, acompanhadas de bebidas leves e sobremesas artesanais.' WHERE id = '1a2b3c4d-0007';
UPDATE restaurantes SET descricao = 'Receitas familiares com ingredientes sempre frescos. Ideal para quem aprecia pratos simples, mas cheios de sabor, como camarão empanado, frango grelhado e massas ao molho de tomate fresco, acompanhados de sobremesas artesanais e bebidas clássicas.' WHERE id = '1a2b3c4d-0008';
UPDATE restaurantes SET descricao = 'Um banquete de sabores do mar e da terra. Combinando carnes nobres e frutos do mar frescos, o cardápio oferece pratos como moqueca de camarão, casquinha de siri e filé mignon ao molho madeira, além de massas artesanais e sobremesas sofisticadas.' WHERE id = '1a2b3c4d-0009';
UPDATE restaurantes SET descricao = 'Culinária rústica com ingredientes orgânicos e da roça. Pratos fortes e tradicionais como leitão assado, costela com mandioca e massas feitas com raízes brasileiras. As bebidas naturais e sobremesas como doce de abóbora com coco complementam essa viagem ao interior.' WHERE id = '1a2b3c4d-0010';
UPDATE restaurantes SET descricao = 'Gastronomia vegana moderna, criativa e deliciosa. O menu inclui desde burgers de grão de bico e lentilha até pratos principais como curry de legumes e lasanha de berinjela. Tudo finalizado com smoothies naturais e sobremesas veganas como mousse de maracujá.' WHERE id = '1a2b3c4d-0011';
UPDATE restaurantes SET descricao = 'Uma explosão de sabores da culinária oriental com um toque moderno. Sushis, sashimis, pratos quentes como yakisoba e frango xadrez, acompanhados de bebidas como saquê e chá de jasmim. As sobremesas orientais finalizam a experiência com delicadeza.' WHERE id = '1a2b3c4d-0012';
UPDATE restaurantes SET descricao = 'Autêntica culinária indiana com pratos vegetarianos e não vegetarianos ricos em temperos e aromas. Oferece clássicos como chicken tikka masala, lamb curry, palak paneer e naan, além de sobremesas como gulab jamun e lassi de manga.' WHERE id = '1a2b3c4d-0013';
UPDATE restaurantes SET descricao = 'Um paraíso de bebidas naturais e saudáveis. Sucos combinados com frutas e ervas, smoothies energéticos, vitaminas cremosas e chás gelados aromatizados com especiarias. Ideal para quem busca refrescância com saúde.' WHERE id = '1a2b3c4d-0014';
UPDATE restaurantes SET descricao = 'Pizzas artesanais com toques gourmet, feitas com ingredientes frescos e combinações criativas. Além das tradicionais, oferece sabores exclusivos como abobrinha com brie e cordeiro com hortelã. Calzones recheados, bebidas e sobremesas italianas completam o cardápio.' WHERE id = '1a2b3c4d-0015';
UPDATE restaurantes SET descricao = 'Cozinha brasileira raiz com pratos fartos e temperos da roça. Feijão tropeiro, frango com quiabo, vaca atolada e arroz com pequi trazem o sabor de Minas e Goiás. Sobremesas como bolo de fubá e goiabada com queijo garantem o toque final da tradição.' WHERE id = 'res-001';
