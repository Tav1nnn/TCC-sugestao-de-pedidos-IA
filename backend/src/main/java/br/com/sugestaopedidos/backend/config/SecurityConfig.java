...
import br.com.sugestaopedidos.backend.filter.SecurityFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "api/categories/**").hasRole("CLIENT")
                        ...
                        .requestMatchers(HttpMethod.GET, "api/ingredients/**").hasRole("CLIENT")
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/restaurants/**").hasRole("ROOT")
                        .requestMatchers(HttpMethod.DELETE, "/api/restaurants/**").hasRole("ROOT")
